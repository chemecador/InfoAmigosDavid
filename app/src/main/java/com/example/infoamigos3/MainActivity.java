...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemLongClickListener,
    ...
    protected void onResume() {
        ...
        } //Asigno a lista de amigos la lista devuelta por el método de la clase de la base de datos
        else {
    ...
    private void confirmarBorrado() {
        ...
        builder.setMessage(R.string.strMensajeBorrado)
                .setTitle(R.string.strTituloBorrado)
                .setPositiveButton(R.string.strAceptar,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                db.eliminarAmigo(amigoSeleccionado);//Llamo al método de la base de datos que borra un amigo

                                onResume();//actualizo la activty para que el elemento borrado ya no aparezca en la lista
